 ...
 */
export function isCodehError(error: unknown): error is CodehError {
	return error instanceof CodehError;
}
...
export function isSymbolNotFoundError(
	error: unknown,
): error is SymbolNotFoundError {
	return error instanceof SymbolNotFoundError;
}
